...
class Config:
    ...
    # Screen awareness: periodic screenshot → vision model ("what is Velle
    # working on"). OFF by default — flip on if you want Chibi to see your
    # desktop. Needs scrot/maim (X11) or grim (Wayland), plus Pillow.
